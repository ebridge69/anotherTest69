$(document).ready(function() {
  ...
  if (navigator.userAgent.search("Safari") >= 0 && navigator.userAgent.search("Chrome") < 0) {
    ...
    var cards = ['abacus', 'blaise', 'charles', 'eniac1', 'john', 'presper'];
            ...
            if (!gameStarted && !running){//before the game starts, show all cards to the user and flip back
                ...
                if (chosenCards[0] == chosenCards[1]) {
                    ...
                    if (pairCount == cards.length) {
                        win = true;
                        swal ("Good Job", "Nice Guess Smartass!", "success")
             ...
             swal ("Ooops", "You have run out of time", "error") 
         }
    ...
    function countdown () {
        ...
        var timer = setInterval( function() {
            ...
            if (time > 0 && !win) {// if there is still time left and game isn't won, deduct time
                ...
                outOfTime = true;
                swal ("Oh no!", "You have run out of time, you can try it again :)", "error")
